...
if [[ $# -lt 1 ]]; then
    echo "Usage: $0 <pkmini_rom.min> [pkmini_rom.c]"
    echo "This will convert the pokemon mini rom into a .c file and update all the references"
    exit 1
fi

INFILE=$1
OUTFILE=loaded_pkmini_rom.c
